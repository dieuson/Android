...
class Auth:
    ...
    def GrabNPSSO(self):
        if self.two_factor_auth_request['ticket_uuid'] and self.two_factor_auth_request['code']:
            ...
            #SSO Djayvi
            # self.npsso = "nZ3k7nqfBb1zVA5kZY4huC1X8zoqbkgg2i0NVVh71HBBvl5gJ3dMriZifc8tAs7I"

            # self.npsso = "W2AbnJH4u1QYmoHHJ9F0nyrB7GAJvbtswx5owMO1NRFQ7SVMoPZq9TAUYTBYDqmk"
            # response = urllib.request.urlopen(request)

            #SSO FortnitePS4Championship
            ##Entrer le code dans le browser et surveiller les request SSO
            self.npsso = "hBCxBbgzeBmBRSn7ZhkLYArajq7X7Euz8ZbmgX6vdfp7MmtzkR71gqfpsizqfnbE"
            self.npsso = "eVefo6QtnjfXVQNkVlA5hsGpo6xLYZltxBvtpbFnvbLasj9rUhJ1OHB3w0B3wRM1"
            self.npsso = "7uZkbS3TYIBZ62NEVAVzr6xEiOTvjSJ3ejNeeoykvpA0KzH7xZAn8zMvd2pi729l"
        else:
